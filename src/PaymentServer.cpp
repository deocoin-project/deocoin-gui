...
const QString BITCOIN_IPC_PREFIX("deocoin:");

static QString ipcServerName()
{
    QString name("Deocoin");
...
PaymentServer::PaymentServer(QApplication* parent) : QObject(parent), saveURIs(true)
{
    ...
    if (!uriServer->listen(name))
        qDebug() << tr("Cannot start deocoin: click-to-pay handler");
    else
...
{
    // clicking on deocoin: URLs creates FileOpen events on the Mac:
