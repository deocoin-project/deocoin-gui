...
if(PROJECT_OS_LINUX OR PROJECT_OS_POSIX) # Linux
    ...
    set(CPACK_PACKAGING_INSTALL_PREFIX "/opt/deocoin-gui")

    # DEB
    set(CPACK_DEBIAN_PACKAGE_MAINTAINER "${CPACK_PACKAGE_VENDOR} <dev@deocoin.org>")
    set(CPACK_DEBIAN_PACKAGE_SECTION Office)
    set(CPACK_DEBIAN_PACKAGE_SHLIBDEPS OFF)

    # RPM
    set(CPACK_RPM_PACKAGE_VENDOR "${CPACK_PACKAGE_VENDOR} <dev@deocoin.org>")
...
elseif(PROJECT_OS_WINDOWS) # Windows
    ...
    set(CPACK_NSIS_CONTACT "${PROJECT_VENDOR_NAME} <dev@deocoin.org>")
